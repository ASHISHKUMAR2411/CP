...
struct cl *exchange_last_first(struct cl *ptr)
{
    struct cl *temp=ptr,*pre=temp;
    if(temp==NULL)
    {
        printf("\n no element to exchange ");
        return temp;
    }
    while(temp->node!=ptr)
    {
...
void swap_first_last(struct cl *ptr)
{
    int swa;
    struct cl *temp=ptr;
    while(temp->node!=ptr)
...
int main()
{
    ...
    while(1)
    {
        ...
        printf("\n8.Count_Nodes");
        printf("\n9.Josephus_Circle");
        printf("\n10.Exchange First With Last");
        printf("\n11.Swapping_data_first_last");
        printf("\n12.exit");
        label:
        printf("\n enter your choice :");
        scanf("%d",&choice);
