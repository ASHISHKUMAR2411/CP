...
void creation_double_pointer(struct tt *ptr);
void display_dll(struct tt *ptr);
int main()
{
    ...
    while (1)
    {
        ...
        printf("\n12.Create_double_pointer and display");
        printf("\n13.Exit");
    logo:
        printf("\nenter your choose :");
        scanf("%d", &choice);
...
void creation_double_pointer(struct tt *ptr)
{
    ...
    if (dd != NULL)
    {
        ...
        if (ptr->left != NULL)
        {
            creation_double_pointer(ptr->left);
        }
        if (ptr->middle != NULL)
        {
            creation_double_pointer(ptr->middle);
        }
        if (ptr->right != NULL)
        {
            creation_double_pointer(ptr->right);
        }
    }
    else
    {
