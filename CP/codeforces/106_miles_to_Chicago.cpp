...
//         double p;
//         cin >> u >> v >> p;
//         adj[u].push_back({v, p/100.000000});
//         adj[v].push_back({u, p/100.000000});
//     } 
//     int k;
//     cin >> k;
//     vector<double> perc(n+1, 0);
//     priority_queue<pair<double, pair<int,int>>> pq;
//     pq.push({100.000000, {1, -1}});
//     perc[1] = 1.000000;
//     while(!pq.empty()){
//         auto top = pq.top();
//         double path = top.first;
...
//             double result = (per * path);
//             if(perc[child] < result){
//                 perc[child] = result;
//                 pq.push({result, {child, node}});
//             }
//         }
//     }
//     cout << fixed << setprecision(6)  << perc[n] << " percent\n";
